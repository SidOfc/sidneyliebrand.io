...
using [.webm](https://caniuse.com/?search=webm) or [.mp4](https://caniuse.com/?search=mp4)
...
More detailed explanations about the options can be found [here](https://trac.ffmpeg.org/wiki/Encode/VP9).
...
When we check caniuse, [.webm support](https://caniuse.com/?search=webm) looks good too, mostly.
...
This will output a .mp4 file that is [widely supported](https://caniuse.com/?search=mp4)
...
More detailed expoanations about the options can be found [here](https://trac.ffmpeg.org/wiki/Encode/H.264).
Additionally, [this commit](https://github.com/manateelazycat/deepin-screen-recorder/commit/a49612faed28fc70a98aa117839cc67d96b99761)
